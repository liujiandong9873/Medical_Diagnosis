...
CHECKPOINT_DIR = MODEL_ROOT / "Generated_Models" / "002002003010_baseline_preserving_residual_f2mi"

EXPERIMENT_ID = "002002003010"
EXPERIMENT_LABEL = "Baseline-preserving fractal-fractional residual F2MI"
...
def write_summary(config: RunConfig, folds: pd.DataFrame, trained: bool, input_status=None, metrics=None) -> None:
    ...
    lines = [
        "# 002002003010 Baseline-Preserving Residual F2MI Run Summary",
        "",
        "## Status",
        "",

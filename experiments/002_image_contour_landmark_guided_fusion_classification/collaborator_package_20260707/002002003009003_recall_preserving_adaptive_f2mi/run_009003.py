...
CHECKPOINT_DIR = MODEL_ROOT / "Generated_Models" / "002002003009003_recall_preserving_adaptive_f2mi"

EXPERIMENT_ID = "002002003009003"
EXPERIMENT_LABEL = "Recall-preserving sample-adaptive F2MI-Transformer"
...
def write_summary(config: RunConfig, folds: pd.DataFrame, trained: bool, input_status=None, metrics=None) -> None:
    ...
    lines = [
        "# 002002003009003 Recall-Preserving Sample-Adaptive F2MI Run Summary",
        "",
        "## Status",
        "",
        ...
        "- Core mechanism: keep the sample-adaptive multimodal router from 009002, remove forced router regularization by default, and select checkpoints by validation F1.",
        f"- Samples: {len(folds)}",
